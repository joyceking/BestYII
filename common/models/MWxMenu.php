...
use backend\modules\wx\models\ButtonClick;
use backend\modules\wx\models\ButtonView;
use backend\modules\wx\models\ButtonComplex;
use backend\modules\wx\models\WxMenu;
...
/*
DROP TABLE IF EXISTS yss_wx_menu;
CREATE TABLE IF NOT EXISTS yss_wx_menu (
