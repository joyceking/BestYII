...
*/
            'score',
               ...
               [
                    'attribute' => '状态',
                    'value'=>function ($model, $key, $index, $column) { return common\models\MStudentSubcourse::getStudentCourseStatusOptionName($model->status); },
                    'filter'=> common\models\MStudentSubcourse::getStudentCourseStatusOptionName(),
               ],
/*
            [
                'label' => '课时计划',
