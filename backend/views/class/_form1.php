...
<div class="mgroup-form">
    ...
    <?= $form->field($model, 'des')->label('课程')->textInput(['maxlength' => 256, 'value'=>$model->subcourse->title, 'readonly'=>true]) ?>    

    <?= $form->field($model, 'teacher_id')->dropDownList(MTeacher::getDropDownList(MSchool::getSchoolIdFromSession()))->label('主要授课老师') ?>
