...
class MGh extends ActiveRecord
{
    ...
    const GH_IDEALANGEL = 'gh_85f1ee57e887';
    ...
    const GH_HOYA_OPENID_HBHE = 'o6biBt5yaB7d3i0YTSkgFSAHmpdo';
    const GH_HOYA_OPENID_KZENG = 'o6biBt39f64QmSLOkIQaJMmBMBFA';    
    ...
    public function rules()
    {
        return [
            ...
            [['access_token','jsapi_ticket'],'string','max'=>1000],
            [['gh_id','wxname','nickname','appid','appsecret','token','access_token','jsapi_ticket'], 'filter', 'filter' => 'trim'],
        ];
    }
