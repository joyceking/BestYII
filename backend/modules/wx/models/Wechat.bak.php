...
class Wechat extends \yii\base\Object
{
	...
	//http://backend.hoyatech.cn/index.php?r=wx/wap/oauth2cb
    ...
    public function getPostStr() 
    {
        if ($this->localTest)        
        {
                ...
                return $this->getDemoRequestXml(Wechat::MSGTYPE_EVENT, Wechat::EVENT_CLICK, 'FuncMyBaby');
...
EOD;
    ...
    public function WxGetOauth2Url($scope='snsapi_userinfo', $state='')
    {
        ...
        //$redirect_uri = urlencode("http://wosotech.com/wx/web/index.php?r=wap/oauth2cb");    
        //$redirect_uri = urlencode("http://backend.hoyatech.cn/index.php?r=wx/wap/oauth2cb");        
