...
/**
   ...
   */
    ...
    public static function getSessionParam($key)
    {
        ...
        {
            return \backend\modules\wx\models\MGh::GH_XIANGYANGUNICOM;
            //return \backend\modules\wx\models\MGh::GH_WOSO;
        }
        else if (Yii::$app->params['isWin'] && $key == 'openid' && Yii::$app->wx->localTest)
        {
            //return \backend\modules\wx\models\MGh::GH_XIANGYANGUNICOM_OPENID_HBHE;        
            return \backend\modules\wx\models\MGh::GH_XIANGYANGUNICOM_OPENID_KZENG;        
            //return \backend\modules\wx\models\MGh::GH_WOSO_OPENID_HBHE;        
            //return \backend\modules\wx\models\MGh::GH_WOSO_OPENID_KZENG;                
        }
        else 
        {
