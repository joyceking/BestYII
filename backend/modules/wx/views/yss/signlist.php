    ...
    <body>
        ...
        <table class="table table-bordered">
            ...
            <?php foreach ($courseSchedules as $courseSchedule) { ?>
                <tr class="success">
                    <td>班级</td>
                    <td colspan="3"><?= $courseSchedule->group->title ?></td>
                </tr>
                <tr class="success">
                    <td>课时</td>
                ...
                <?php foreach ($courseSchedule->courseScheduleSignons as $signon) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else if ($signon->is_signon == MCourseScheduleSignon::SIGNON_STATUS_ABSENCE) { ?>
                                <span style='color:blue' class='glyphicon glyphicon-ok'><?php echo Yii::t('backend', 'Signon Absence') ?></span>
                            <?php } else { ?>
